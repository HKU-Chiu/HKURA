...
%
% Calculates radiomic features for esophagus dataset
% Output is saved as xlsx and .mat
% (Derived from IBEX source code, v1.0 beta, release date 15/8/2017)

PARAM.data_root     = "path_to_data";
PARAM.settings.file = 'IBEX_Featureset.mat';
