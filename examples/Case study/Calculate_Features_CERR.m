%--- DESCRIPTION
% Standard script template. Executes mainfcn.
%
% mainfcn calculates the CERR features for our esophagus dataset
% Output is saved as xlsx and .mat
% Dependencies assumed be inside folder: DEPEND/[mfilename] 
% The dicom loader prefers previously created VOLUME_IMAGE.mat, if available
% (CERR project master branch, github commit: 57796bb) 

PARAM.data_root     = "C:\Users\Jurgen\Documents\PROJECT ESOTEXTURES\Data_Eso";
PARAM.settings.file = 'all_features_quantized.json';
PARAM.chooseDepend  = false;  %false: assume default depend locations
PARAM.fileprefix    = 'cerr'; %output name prefix
