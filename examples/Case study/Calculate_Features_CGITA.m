%--- DESCRIPTION
% mainfcn calculates the 108 CGITA(v1.4) features for our esophagus dataset
% output is saved as xlsx and .mat
% Dependency folder assumed to have SAME NAME as this script
% The dicom loader prefers previously created VOLUME_IMAGE.mat files, if available.

PARAM.data_root     = "C:\Users\Jurgen\Documents\PROJECT ESOTEXTURES\Data_Eso";
PARAM.settings.file = 'feature_settings.mat';
