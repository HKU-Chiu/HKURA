...
%   $Revision: 1.1.6.8 $  $Date: 2004/10/20 17:54:37 $
...
metadata = My_dicom_prep_metadata(IOD_UID, metadata, X, map, options.txfr);
...
for p = 1:numel(private_tags)
    attrs(p) = dicom_convert_meta_to_attr(private_names{p}, metadata);
end
