...
metadata.(dicom_name_lookup('0002', '0001')) = uint8([0 1]);     %FileMetaInformationVersion
% metadata.(dicom_name_lookup('0002', '0002')) = IOD_UID;       %MediaStorageSOPClassUID
% metadata.(dicom_name_lookup('0002', '0003')) = ...
%     metadata.(dicom_name_lookup('0008', '0018'));                       %MeidaStorageSOPInstanceUID
metadata.(dicom_name_lookup('0002', '0010')) = txfr;
% 
% [uid, name] = get_implementation_details;
% metadata.(dicom_name_lookup('0002', '0012')) = uid;                    %ImplemenationClassUID
% metadata.(dicom_name_lookup('0002', '0013')) = name;                 %ImplementationVersionName
