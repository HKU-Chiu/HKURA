...
%   $Revision: 1.3.4.8 $  $Date: 2004/10/20 17:54:34 $
...
vr_details(14).Types_accept    = {'uint16', 'int16', 'uint32', 'uint8', 'int8'};   %Joy
...
case 'UN'
    ...
    if (isnumeric(data_in))
        data_out = DcmCast(data_in, 'uint8');
    else
        data_out = data_in;
    end
