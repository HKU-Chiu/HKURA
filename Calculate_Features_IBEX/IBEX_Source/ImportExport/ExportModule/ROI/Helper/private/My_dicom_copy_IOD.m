...
%   $Revision: 1.1.6.4 $  $Date: 2004/08/10 01:44:41 $
...
metadata = My_dicom_prep_FileMetadata(metadata, IOD_UID, options.txfr);
metadata = My_dicom_prep_ImagePixel(metadata, X, map, options.txfr);
