function FeatureInfo=IntensityHistGaussFitOrgan_Feature(ParentInfo, FeatureInfo, Mode)
...
function [Value, ReviewInfo]=IntensityHistGaussFitOrgan_Feature_NumberOfGauss(ParentInfo, Param)
%%%Doc Starts%%%
...
function [Value, ReviewInfo]=IntensityHistGaussFitOrgan_Feature_GaussAmplitude(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
...
%Feature: GaussMean
function [Value, ReviewInfo]=IntensityHistGaussFitOrgan_Feature_GaussMean(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
...
%Feature: GaussStd
function [Value, ReviewInfo]=IntensityHistGaussFitOrgan_Feature_GaussStd(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
...
%Feature: GaussArea
function [Value, ReviewInfo]=IntensityHistGaussFitOrgan_Feature_GaussArea(ParentInfo, Param)
%%%Doc Starts%%%
%-Description: 
