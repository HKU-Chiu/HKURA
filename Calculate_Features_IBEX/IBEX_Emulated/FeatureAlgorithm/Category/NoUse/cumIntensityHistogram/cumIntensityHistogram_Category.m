function ParentInfo=cumIntensityHistogram_Category(DataItemInfo, Mode, Param)
...
%****The skeleton category adds 200 to image data****%
DataItemInfo.ROIImageInfo.MaskData=DataItemInfo.ROIImageInfo.MaskData;
