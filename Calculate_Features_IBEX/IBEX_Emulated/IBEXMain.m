function varargout = IBEXMain(varargin)
...
%
%      IBEXMAIN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IBEXMAIN.M with the given input arguments.
%
%      IBEXMAIN('Property','Value',...) creates a new IBEXMAIN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before IBEXMain_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to IBEXMain_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help IBEXMain

% Last Modified by GUIDE v2.5 16-Jun-2015 23:07:36
...
%Read configuration
if ~isdeployed
    ConfigFile=[handles.ProgramPath, '\IBEX.INI'];
else
    CTFPath=ctfroot;
    TempIndex=strfind(CTFPath, '\');
    CTFPath=CTFPath(1:TempIndex(end)-1);   
    
    ConfigFile=[CTFPath, '\IBEX.INI'];
end
...
switch Mode
    case 0
        LabelStr= '<html><center><a href="">IBEX is Intended for Research Use Only.';
...
set(handles.PushbuttonSite, 'CData', CIcon, 'String', '', 'BackgroundColor', [220, 220, 220]/255);

[CIcon, map]=imread('MainImport.jpg');
set(handles.PushbuttonImportPat, 'CData', CIcon, 'String', '', 'BackgroundColor', [220, 220, 220]/255);

[CIcon, map]=imread('MainData.jpg');
set(handles.PushbuttonSpecifyData, 'CData', CIcon, 'String', '', 'BackgroundColor', [220, 220, 220]/255);

[CIcon, map]=imread('MainMethod.jpg');
set(handles.PushbuttonSpecifyModel, 'CData', CIcon, 'String', '', 'BackgroundColor', [220, 220, 220]/255);

[CIcon, map]=imread('MainExit.jpg');
set(handles.PushbuttonExit, 'CData', CIcon, 'String', '', 'BackgroundColor', [220, 220, 220]/255);

[CIcon, map]=imread('MainResult.jpg');
set(handles.PushbuttonGetView, 'CData', CIcon, 'String', '', 'BackgroundColor', [220, 220, 220]/255);

[CIcon, map]=imread('MainModel.jpg');
set(handles.PushbuttonModel, 'CData', CIcon, 'String', '', 'BackgroundColor', [220, 220, 220]/255);

TextStr='<html><b><center><font size="5" face="Times New Roman" color="rgb(0,0,0)">Developer<br />Studio</font></html>';
set(handles.PushbuttonDevelop, 'String', TextStr,'BackgroundColor', [255, 255, 255]/255);
