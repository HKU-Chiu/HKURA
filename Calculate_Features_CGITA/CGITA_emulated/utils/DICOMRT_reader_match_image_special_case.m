function ROI_struct = DICOMRT_reader_match_image_special_case(filename, handles, SUV_cutoff);%, zV, x1, y1, z1, x2, y2, z2)
...
%     end
    ...
    ROI_struct(idx).structureName = name_list{idx};
